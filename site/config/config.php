...
define('DB_NAME', 'ht233666');  // Nom de la base de données
define('DB_USER', 'ht233666');  // Nom d'utilisateur de la base de données
define('DB_PASS', 'bidon123');  // Mot de passe de la base de données
